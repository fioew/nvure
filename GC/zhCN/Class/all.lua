...
function amAllClassInf(SpellIds,NoSpellTarget,BuffNames)
	...
	----要塞技能
	SpellIds["要塞技能"]=161691;
	SpellIds["战斗的召唤"]=161676;
	SpellIds["召唤机械切割者5000"]=164050;
	SpellIds["守护宝珠"]=161767;
        SpellIds["火炮轰击"]=162075;
	SpellIds["塔拉塔布羊"]=165803;
	---阿什兰
        SpellIds["升腾"]=161862;
	...
	----要塞
	NoSpellTarget[SpellIds["要塞技能"]] = true;
	NoSpellTarget[SpellIds["战斗的召唤"]] = true;
	NoSpellTarget[SpellIds["召唤机械切割者5000"]] = true;
        NoSpellTarget[SpellIds["守护宝珠"]] = true;
	NoSpellTarget[SpellIds["火炮轰击"]] = true;
        NoSpellTarget[SpellIds["塔拉塔布羊"]] = true;
        -----阿什兰
        NoSpellTarget[SpellIds["升腾"]] = true;
...
---要塞技能
IgnoreSpellIds["要塞技能"]=161691;
IgnoreSpellIds["战斗的召唤"]=161676;
IgnoreSpellIds["召唤机械切割者5000"]=164050;
IgnoreSpellIds["守护宝珠"]=161767;
IgnoreSpellIds["火炮轰击"]=162075;
IgnoreSpellIds["塔拉塔布羊"]=165803;
----阿什兰
IgnoreSpellIds["升腾"]=161862;
...
function amTestSpellBook(SpellIds)
	...
	while true do
		...
		local func = assert(loadstring("C_SpellBook.GetSpellBookItemInfo(" .. i ..", 'player')"));
