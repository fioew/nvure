	...
	function Lib.CreateMain(name,parent,text)
		-- New Frame
		frame = CreateFrame("Frame", name, parent, BackdropTemplateMixin and "BackdropTemplate" or nil)
		frame:Hide();
		frame:SetWidth(400)
		frame:SetHeight(300)
		frame:SetMovable(1)
		...
		local title = CreateFrame("Frame", "$parent_Caption", frame, BackdropTemplateMixin and "BackdropTemplate" or nil)
	...
	function Lib.CreateEditer(name,parent,ref)
		...
		local scrollBackground = CreateFrame("Frame", "$parent_CodeBackground", frame, BackdropTemplateMixin and "BackdropTemplate" or nil);
...
--[[	frame.DDEdit:SetScript("OnEnterPressed",function(self)
	...
	--DropdownList Frame
	frame.DDList=CreateFrame("Frame", name .. "List", frame, BackdropTemplateMixin and "BackdropTemplate" or nil);
...
function Lib.CreateDropDownSearch2(name,parent,default,list,applyfunc)
	--Container Frame
	local DropDownSearch=CreateFrame("Frame",name,parent, BackdropTemplateMixin and "BackdropTemplate" or nil);
	...
	--DropdownList Frame
	DropDownSearch.DDList=CreateFrame("Frame",name .. "List",DropDownSearch, BackdropTemplateMixin and "BackdropTemplate" or nil);
...
function Lib.CreateSingleEditBox(name,parent,default)
	local EditBoxContainer=CreateFrame("Frame",name,parent, BackdropTemplateMixin and "BackdropTemplate" or nil);
